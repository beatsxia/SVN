...
Calendar.prototype.show = function(dateControl, popuControl) {
	...
	this.panel.style.left = xy.x  - (200-$("#date_begin").width())/1.9 + "px";
...
__ci.document.writeln('select.year {width:71px;}');
__ci.document.writeln('select.month {width:56px;}');
