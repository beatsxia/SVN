<?php
require_once APPPATH."libraries/weipay/lib/WxPay.Exception.php";
require_once APPPATH."libraries/weipay/lib/WxPay.Config.php";
require_once APPPATH."libraries/weipay/lib/WxPay.Data.php";
