...
<html>
	...
	<link rel="stylesheet" href="<?php echo $inc_url; ?>css/kongzi.css" />
	...
	<body>
        <div class="bg">
		    ...
		    <div class="stele_navbar_left">
			    <img src="<?=$inc_url?>img/navbar4_sec.png" class="navbar4" />
			    <img src="<?=$inc_url?>img/navbar5_sec.png" class="navbar5" />
		    </div>
		    <!--底部按钮-->
		    <div class="stele_navbar_footer">
			    <img src="<?=$inc_url?>img/navbar1_sec.png" class="navbar1" />
			    <img src="<?=$inc_url?>img/navbar2_sec.png" class="navbar2" />
			    <img src="<?=$inc_url?>img/navbar3_sec.png" class="navbar3" />
		    </div>
		    <!--碑信息-->
		    <div class="inheritor_info">
			    ...
			    <div class="inheritor_name"><strong><?=$stele_info['title']?></strong></div>
		    </div>
		    <!--香炉-->
		    <div class="inc_bur">
		    	<img src="<?=$inc_url?>img/inc_bur.png" />
		    </div>
		    <!--香-->
		    <div class="inc_look">
			    <img src="<?=$inc_url?>img/inc.gif" />
		    </div>
		    <!--右花-->
		    <div class="send_flower_right send_flower">
			    <img src="<?=$inc_url?>img/flower_rg.png" />
		    </div>
		    <!--左花-->
		    <div class="send_flower_left send_flower">
			    <img src="<?=$inc_url?>img/flower_lf.png" />
		    </div>
		    <!--榜单-->
...
$(".delete").click(function(){
	...
	$(".bg").css("-webkit-animation","sky_background 7s ease-out 1");
	$(".bg").css("-moz-animation","sky_background 7s ease-out 1");
	$(".bg").css("-o-animation","sky_background 7s ease-out 1");
	$(".bg").css("animation","sky_background 7s ease-out 1");
	$(".bg").css("-webkit-transform","translate3d(0, 0, 0)");
	$(".bg").css("-moz-transform","translate3d(0, 0, 0)");
	$(".bg").css("-o-transform","translate3d(0, 0, 0)");
	...
	if($(".clouds_two").css("display", "none")) {
		...
		var ihthpb = $(".inheritor_head").width();
		$(".inheritor_head img").height(ihthpb*1.087);
		
	    $(".inheritor_name").css("margin-left",($(window).width()-$(".inheritor_name").width())/2);
		...
		$(".navbar1").click(function() {
			...
			$(".list_logo").empty().append("<img src='<?=$inc_url?>img/nav_list.png' >");
		...
		$(".navbar2").click(function() {
			...
			$(".list_logo").empty().append("<img src='<?=$inc_url?>img/nav_contri.png' >");
			        ...
			        $.ajax({
				        ...
				        success: function(data) {
                            ...
                            if(data.code == '1'){
                                ...
                                sx_top.innerHTML = '@keyframes myfirst {0%{bottom: 0%;} 20%{bottom: 45.5%;} 100%{bottom: 44.8%;;}}'+
                                '@-webkit-keyframes myfirst {0%{bottom: 0%;} 20%{bottom: 45.5%;} 100%{bottom: 44.8%;}}'+
                                '@-moz-keyframes myfirst {0%{bottom: 0%;} 20%{bottom: 45.5%;} 100%{bottom: 44.8%;}}'+
                                '@-o-keyframes myfirst {0%{bottom: 0%;} 20%{bottom: 45.5%;} 100%{bottom: 44.8%;}}'
			                    $(".seen").animate({
				                    opacity: "0"
			                    }, 4000);
		                        $(".seen img").animate({
...
//              	            alert("赠送成功！");
		...
		$(".navbar4").click(function() {
			...
			$(".list_logo").empty().append("<img src='<?=$inc_url?>img/nav_trends.png' >");
