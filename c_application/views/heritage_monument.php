...
<html>
	...
	<body>
	  <div class="all_cont">
	  	<div style="width: 100%;height: 27.5%;border-bottom: 1px #E7E9E8 solid;position: fixed;top: 0;z-index: 99;">
	  		<img src="<?php echo $inc_url;?>img/bg_top.jpg" width="100%" height="100%" />
	  	</div>
	  	<div class="scroll_me">
		<div class="add_msg">
			<div class="msg_lf">
