...
<head>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				$('#dlg').dialog('open').dialog('setTitle','编辑传记');
				$('#fm').form('load',row);
				url = 'inh/edit_inh?id='+row.id;
			}
		}
		function saveUser(){
			$('#fm').form('submit',{
		...
		<div id="content" region="center" title="内容" style="padding:5px;">
			<table id="dg" title="传记列表" class="easyui-datagrid" style="width:960px;height:600px"
				...
				<thead>
					<tr>
						...
						<th field="is_open" width="50">是否公开</th>
						<th field="stele_id" width="50">关联传承碑</th>
					</tr>
				</thead>
			</table>
			<script>
			...
			<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
				...
				<form id="fm" method="post" novalidate>
					...
					<div class="fitem">
						<label>是否公开</label>
						<input type="radio" name="is_open" value="0"><span>隐藏</span>
						<input type="radio" name="is_open" value="1"><span>公开</span>
					</div>
				</form>
			</div>
			<div id="dlg-buttons">
